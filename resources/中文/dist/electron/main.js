...
function(t, n, e) {
    ...
    s = function(t, n, e) {
        ...
        w = x[a],
        _ = v ? r: d ? r[n] : (r[n] || {})[a];
        for (f in v && (e = n), e)(l = !h && _ && void 0 !== _[f]) && u(x, f) || (p = l ? _[f] : e[f], x[f] = v && "function" != typeof _[f] ? e[f] : g && l ? i(p, r) : m && _[f] == p ?
        function(t) {
...
function(t, n, e) {
    ...
    t.exports = function(t, n, e, y, g, m, x) {
        ...
        if (k && ((b = f(k.call(new t))) !== Object.prototype && b.next && (s(b, j, !0), !r && "function" != typeof b[l] && c(b, l, d))), S && E && E.name !== v && (L = !0, M = function() {
            return E.call(this)
        }), (!r || x) && (p || L || !P[l]) && c(P, l, M), u[n] = M, u[j] = d, g) if (w = {
            values: S ? M: O(v),
            keys: m ? M: O(h),
            entries: T
        },
        x) for (_ in w) _ in P || i(P, _, w[_]);
...
function(t, n, e) {
    ...
    f.addEventListener("message", w, !1)) : r = m in s("script") ?
    function(t) {
...
default = function(t) {
        ...
        default((function(t, e) {
                return function o(i, c) {
                    ...
                    return u.done ? void t(a) : r.
                default.resolve(a).then((function(t) {
                        o("next", t)
                    }), (function(t) {
                        o("throw", t)
                    }))
...
default ||
    function(t) {
        for (var n, e = 1; e < arguments.length; e++) for (var r in n = arguments[e]) Object.prototype.hasOwnProperty.call(n, r) && (t[r] = n[r]);
        return t
    }
},
function(t, n, e) {
    ...
    function r() {
        ...
        n = {};
        try {
            var r = JSON.parse(v.readFileSync(g, "utf8")).bounds;
            r && (n = r)
        } catch(n) {} (d = new p.BrowserWindow(l()({
            height: 603,
            width: 850,
            minWidth: 850,
            minHeight: 603,
        ...
        n))).setMenu(null),
        d.webContents.on("will-navigate", (function(t) {
        ...
        d.on("close", (function(t) {
            return p.app.isQuiting || (t.preventDefault(), d.hide()),
            !1
        })),
        ...
        d.webContents.on("crashed", u()(i.a.mark((function n() {
            ...
            return i.a.wrap((function(t) {
                ...
                case 0:
                    ...
                    t.next = 3,
                    p.dialog.showMessageBox(d, e);
                case 3:
                    r = t.sent,
                    0 === r.response ? (p.app.relaunch(), p.app.exit(0)) : p.app.quit();
                case 6:
                case "end":
                    return t.stop()
                }
        ...
        e(0).powerMonitor.on("resume", (function() {
            d.webContents.send("app-resume")
        })),
        (y = new p.Tray(e(24).join(__static, "tray_normal_Z8R_icon.ico"))).setToolTip("ClashR for Windows"),
        y.on("click", (function() {
            d.show()
        })),
    ...
    h = (e.n(p), e(24)),
    v = e(87);
    global.__static = e(24).join(__dirname, "/static").replace(/\\/g, "\\\\"),
    p.app.disableHardwareAcceleration();
    var d = void 0,
    y = void 0,
    g = h.join(p.app.getPath("userData"), "window_ocnfig.json"),
    m = "file://" + __dirname + "/index.html",
    x = p.app.requestSingleInstanceLock();
    p.app.setAppUserModelId("com.lbyczf.clashwin"),
    p.app.setAsDefaultProtocolClient("clash"),
...
function(t) { !
    function(n) {
        ...
        function i() {}
        function c() {}
        function u(t) { ["next", "throw", "return"].forEach((function(n) {
                t[n] = function(t) {
        ...
        function f(t, n) {
            ...
            if (void 0 === e) {
                if (n.delegate = null, "throw" === n.method) {
                    if (t.iterator.
                    return && (n.method = "return", n.arg = void 0, f(t, n), "throw" === n.method)) return E;
                    n.method = "throw",
        ...
        function v(t) {
            if (t) {
                ...
                if (!isNaN(t.length)) {
                    var e = -1,
                    r = function n() {
                        for (; ++e < t.length;) if (g.call(t, e)) return n.value = t[e],
                        n.done = !1,
                        n;
        ...
        if (O) b && (t.exports = O);
        else { (O = n.regeneratorRuntime = b ? t.exports: {}).wrap = e;
            ...
            i.prototype = C.constructor = c,
            c.constructor = i,
            c[_] = i.displayName = "GeneratorFunction",
            ...
            h.prototype = {
                constructor: h,
                reset: function(t) {
                    if (this.prev = 0, this.next = 0, this.sent = this._sent = void 0, this.done = !1, this.delegate = null, this.method = "next", this.arg = void 0, this.tryEntries.forEach(p), !t) for (var n in this)"t" === n.charAt(0) && g.call(this, n) && !isNaN( + n.slice(1)) && (this[n] = void 0)
                },
                stop: function() {
                    this.done = !0;
                ...
                abrupt: function(t, n) {
                    for (var e, r = this.tryEntries.length - 1; 0 <= r; --r) if ((e = this.tryEntries[r]).tryLoc <= this.prev && g.call(e, "finallyLoc") && this.prev < e.finallyLoc) {
                        var o = e;
                        break
                    }
                ...
                finish: function(t) {
                    for (var n, e = this.tryEntries.length - 1; 0 <= e; --e) if ((n = this.tryEntries[e]).finallyLoc === t) return this.complete(n.completion, n.afterLoc),
                    p(n),
                    E
                },
                catch: function(t) {
                    for (var n, e = this.tryEntries.length - 1; 0 <= e; --e) if ((n = this.tryEntries[e]).tryLoc === t) {
                        var r = n.completion;
                        if ("throw" === r.type) {
                            var o = r.arg;
                            p(n)
...
function(t, n, e) {
    ...
    s = function() {
        var t, n = e(19)("iframe"),
        r = i.length;
        for (n.style.display = "none", e(34).appendChild(n), n.src = "javascript:", (t = n.contentWindow.document).open(), t.write("<script>document.F=Object<\/script>"), t.close(), s = t.F; r--;) delete s[a][i[r]];
        return s()
    };
    t.exports = Object.create ||
    function(t, n) {
        var e;
        return null === t ? e = s() : (u[a] = r(t), e = new u, u[a] = null, e[c] = t),
        void 0 === n ? e: o(e, n)
    }
},
function(t, n, e) {
...
function(t, n, e) {
    ...
    D = function(t) {
        ...
        if (!e._d) {
            ...
            e = e._w || e;
            try {
                if (e === t) throw j("Promise can't be resolved itself"); (n = R(t)) ? m((function() {
                    var r = {
                        _w: e,
                        _d: !1
                    };
...
function(t, n, e) {
    ...
    f = {}; (n = t.exports = function(t, n, e, l, p) {
        ...
        if (i(g)) {
            for (h = u(t.length); h > x; x++) if ((y = n ? m(c(v = t[x])[0], v[1]) : m(t[x])) === s || y === f) return y
...
function(t, n, e) {
    ...
    function(t) {
        for (var n = c(t), e = arguments.length, a = 1, s = o.f, f = i.f; e > a;) for (var l, p = u(arguments[a++]), h = s ? r(p).concat(s(p)) : r(p), v = h.length, d = 0; v > d;) f.call(p, l = h[d++]) && (n[l] = p[l]);
        return n
    }: a
},
function(t, n) {
