...
function (e, t, n) {
    ...
    var Z = {
        ...
        computed: y()({},
            ...
            statusHint: function () {
                return 0 < this.pkgDownloadProgress && 1 > this.pkgDownloadProgress ? "Download progress: " + (100 * this.pkgDownloadProgress).toFixed(2) + "%" : 0 === this.clashStatus ? "Connected" : -1 === this.clashStatus ? "Silent Mode" : 1 === this.clashStatus ? "Disconnected" : 2 === this.clashStatus ? "Setting DNS..." : 3 === this.clashStatus ? "Installing" : void 0
            },
            statusIcon: function () {
                return {
                    "clash-status-icon": !0,
            ...
            return v()(f.a.mark((function t() {
                ...
                return f.a.wrap((function (t) {
                    for (; ;) switch (t.prev = t.next) {
                        ...
                        case 23:
                            e.showStartup || (e.showStartup = !0, e.showNotification("Clash is running in the background", "Enjoy your free time!")),
            ...
            methods: p()({},
                ...
                itemTheme: function (e) {
                    ...
                    return this.isClickableValue(e) && t.push("clickable-" + this.theme),
                        "Home Directory" === e.key && t.push("item-path"),
                        t
                },
